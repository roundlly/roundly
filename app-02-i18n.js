...
// All fragments share ONE global scope and MUST load in numeric order — do not reorder.
    ...
    const STRINGS = {
      en: {
        ...
        'games.classicMeta': '2–20 players · No timer',
        ...
        'games.chameleonMeta': '3–20 players · Quick rounds',
        ...
        'games.liarMeta': '2–20 players · Bluff & survive',
        'games.mafia': 'Mafia',
        ...
        'games.mafiaMeta': '5–20 friends · 1 narrates',
        ...
        'games.mafiaCardsMeta': '5–20 friends · 1 narrates',
        ...
        'mafiaCards.role.winTitle': 'How to win',
        ...
        'mafiaCards.script.detectiveHint': 'Glance at who’s who, then give the Detective a discreet 👍 if Mafia, 👎 if not.',
        'mafiaCards.script.mafiaWakeNote': 'Wait for all {n} Mafia to open their eyes and agree on one target.',
        'mafiaCards.script.mafiaWakeNoteSolo': 'Wait for the Mafia to open their eyes and choose a target.',
        'mafiaCards.script.dayRevealHint': 'Announce who died last night — or that nobody died. The eliminated player does not join the discussion.',
        'mafiaCards.script.voteCardsLine': 'It’s time to vote. Vote for the player you want to eliminate.',
        'mafiaCards.script.voteCardsLineDay1': 'Since it’s the first day, players may choose to vote or skip. If everyone agrees to skip, no one is eliminated.',
        'mafiaCards.script.voteNote': 'Eliminate the player with the most votes. If there’s a tie or everyone agrees to skip, no one is eliminated. After the player is eliminated, decide as a group whether to reveal their role or keep it hidden.',
        'mafiaCards.script.dayDiscussNote': 'Let the players discuss freely while you stay neutral. Move on to the vote when everyone is ready.',
        ...
        'mafiaCards.rules.r2.body': 'When you say "Detective, wake up," the Detective opens their eyes and silently points at one player. Glance at Who\'s who to check that player\'s role, then give the Detective a <strong>thumbs-up if they\'re Mafia</strong>, <strong>thumbs-down if not</strong>. Keep your hand low so only the Detective sees.',
        'mafiaCards.rules.r2.exception': 'If the Mafia Leader is in the game and the Detective points at them, lie — give a thumbs-down (innocent). The Mafia Leader is hidden from the Detective. That\'s their special power.',
        ...
        'mafiaCards.rules.win.title': 'Win conditions',
        'mafiaCards.rules.win.body': 'Check after each round, before the next night begins. The Town wins when every Mafia has been voted out. The Mafia win when their numbers equal or outnumber the other players. If neither side has won yet, play continues to the next night.',
        // Narrator screen (script-first redesign) — stage headings, the Next
        // button, the toolbar (Who's who · Rules · How to play) and its sheets.
        'mafiaCards.stage.openingTitle': 'Opening night',
        'mafiaCards.stage.nightTitle': 'Night {n}',
        'mafiaCards.stage.dayTitle': 'Day {n}',
        'mafiaCards.stage.readAloud': 'Read out loud',
        'mafiaCards.stage.nextFirstNight': 'Next — start the first night',
        'mafiaCards.stage.nextWakeTown': 'Next — wake the town',
        'mafiaCards.stage.nextStartNight': 'Next — start the night',
        'mafiaCards.who.btn': 'Who’s who',
        'mafiaCards.who.title': 'Who’s who',
        'mafiaCards.rules.whoSub': 'Your secret cheat sheet — players never see this. Glance here when the Detective points at someone.',
        'mafiaCards.rules.openBtn': 'Rules',
        'mafiaCards.rules.sheetTitle': 'Rules',
        'mafiaCards.rules.intro': 'Tap a rule to read it.',
        ...
        'mafia.prototypeHint': '<strong>Each player on their own phone.</strong> One person becomes the narrator — they run the game with on-screen prompts but don\'t play. Need 5–20 players + 1 narrator.',
        ...
        'mafia.rolemixWaiting': 'Need 5–20 players for a balanced game.',
        ...
        'mafia.hintTooMany': 'Too many players. Max 20.',
        ...
        'mafia.script.opening.night1MafiaMeet.solo': 'Mafia, open your eyes so I can see you — you\'re on your own tonight.',
        'mafia.script.opening.night1MafiaMeet.soloDir': 'Pause a moment — just confirm who the Mafia is, then have them close their eyes.',
        ...
        'mafia.script.middle.dayDiscuss.text': 'Now it’s time to discuss. Who do you think is in the Mafia, and why?',
        ...
        // "Join a game" tile (Games tab) — two ways in: type a code, or scan a QR.
        'joinGame.title': 'Join a game',
        'joinGame.sub': 'Got a code or QR from a friend?',
        'joinGame.enterCode': 'Enter code',
        'joinGame.scanQr': 'Scan QR',
        'qrScan.title': 'Scan a friend\'s QR',
        'qrScan.instruction': 'Point your camera at the QR on their screen.',
        'qrScan.starting': 'Starting camera…',
        'qrScan.notHuddle': 'That\'s not a Huddle game QR.',
        'qrScan.permissionDenied': 'Camera is off. Allow camera access, or enter the code instead.',
        'qrScan.noCamera': 'No camera found. Enter the code instead.',
        'qrScan.enterInstead': 'Enter code instead',
        ...
        'friends.search': 'Add friend by name or username',
        'friends.searchPlaceholder': 'Add friend by name or username',
        ...
        'friends.emptyList': 'Your friends list is empty. Search above to add friends by name or username.',
        'friends.emptyRequests': 'No friend requests right now.',
        'friends.heroTitle': 'Find your friends',
        'friends.heroSub': 'Type a friend’s name or username in the search box above to send them a friend request.',
        ...
        'lobby.howToSub_link': 'Guess the Theme rules',
        // Guess the Theme — manually-paced how-to walkthrough (8 steps)
        'tg.howto.s1.eyebrow': 'THE SETUP',
        'tg.howto.s1.title': 'Welcome to Guess the Theme',
        'tg.howto.s1.body': 'You\'re all in the same room, each on your own phone. One player takes the hot seat 🔥 — everyone else is a helper.',
        'tg.howto.s2.eyebrow': 'THE SECRET',
        'tg.howto.s2.title': 'Helpers get a secret theme',
        'tg.howto.s2.body': 'Every round has one — like "Things that are sticky". Helpers see it on their phones. The hot seat sees nothing.',
        'tg.howto.s3.eyebrow': 'WHAT YOU SAY',
        'tg.howto.s3.title': 'Name real things that fit',
        'tg.howto.s3.body': 'Helpers take turns saying things that fit the theme. Be sneaky — honey is also sweet and yellow, so keep them guessing!',
        'tg.howto.s4.eyebrow': 'THE ESCAPE',
        'tg.howto.s4.title': 'Guess the theme out loud',
        'tg.howto.s4.body': 'The hot seat listens and shouts the theme when it clicks. The faster you escape, the higher you rank.',
        'tg.howto.s5.eyebrow': 'BUSTED',
        'tg.howto.s5.title': 'Point at who gave it away',
        'tg.howto.s5.body': 'Escaped? Pick whose clue spilled it. Every pick counts — the biggest giver gets called out on the final standings 😅',
        'tg.howto.s6.eyebrow': 'WHO\'S NEXT',
        'tg.howto.s6.title': 'Three ways to pass the seat',
        'tg.howto.s6.body': 'The host picks one in the game settings ⚙️ — "Giver goes next" is the classic way to play.',
        'tg.howto.s7.eyebrow': 'THEME PACKS',
        'tg.howto.s7.title': 'Pick your deck of themes',
        'tg.howto.s7.body': 'The host also picks a theme pack in settings ⚙️. No theme ever repeats — when the deck runs out, the game ends with final standings 👑',
        'tg.howto.s8.eyebrow': 'READY',
        'tg.howto.s8.title': 'That\'s it — you\'re ready!',
        'tg.howto.s8.body': 'Round up your friends, stay sneaky, and don\'t give it away.',
        'tg.howto.hotSeatTag': 'Hot seat',
        'tg.howto.themeExample': 'Things that are sticky',
        'tg.howto.helperPhone': 'Helpers see',
        'tg.howto.hotPhone': 'Hot seat sees',
        'tg.howto.clue1': 'Honey',
        'tg.howto.clue2': 'Glue',
        'tg.howto.clue3': 'Tape',
        'tg.howto.dontSay': '🤫 Never say the theme itself!',
        'tg.howto.shout': '"Things that are sticky!"',
        'tg.howto.escaped': '⏱ Escaped in 8s',
        'tg.howto.gaveItAway': 'Gave it away!',
        'tg.howto.way.giver': 'Give it away → the seat is yours.',
        'tg.howto.way.rotating': 'The seat goes around in seat order.',
        'tg.howto.way.random': 'Anyone could be next.',
        'tg.howto.default': 'Default',
        'tg.howto.letsPlay': 'Let\'s play 🎉',
        'tg.howto.replay': 'Watch again',
        'tg.howto.credit': 'Inspired by the Hot Seat party game.',
        ...
        'howTo.link.slide2Title': 'One guesses the theme',
        'howTo.link.slide2Sub': 'Helpers see a secret theme — like "things that are sticky". The hot seat can\'t see it.',
        'howTo.link.slide3Title': 'Helpers name things that fit',
        'howTo.link.slide3SubHtml': 'Take turns saying real things that fit — honey, glue, tape. Be a little sneaky: <strong>don\'t make it too obvious</strong>.',
        'howTo.link.slide4Title': 'Give it away? You\'re next!',
        'howTo.link.slide4SubHtml': 'Guess fast to escape. And watch out, helpers — <strong>whoever gives it away goes in the hot seat next.</strong>',
        'lobby.settings': 'Settings',
        // Mode-settings sheet (gear button next to Start game)
        'lobby.gameSettings': 'Game settings',
        'modeset.hostOnly': 'Only the host can change these settings.',
        // Guess the Theme — theme pack picker (packs defined in LINK_PACKS, app-01)
        'lobby.themePack': 'Theme pack',
        'themePack.sub': 'Pick which themes can come up this game.',
        'themePack.count': '{n} themes',
        'pack.mixed': 'Mixed — everything',
        'pack.classic': 'Classic mix',
        'pack.everyday': 'Everyday life',
        'pack.places': 'Places & moments',
        'pack.funny': 'Funny & tricky',
        ...
        'mode.link': 'Guess the Theme',
        'mode.sub_link': 'Friends name things — you guess what connects them.',
        'mode.hint_link': '<b>Guess the Theme —</b> Helpers name things that fit a secret theme; the hot seat guesses what connects them. Give it away and you\'re next in the seat!',
        // In-play mode pill (shown under role hero, reminds players of the active rule)
        'play.modePill.silent': 'No talking — act it out',
        'play.modePill.link': 'Guess the Theme',
        'lobby.rounds': 'Rounds',
        ...
        'lobby.lockRoom': '🔓 Lock room',
        'lobby.unlockRoom': '🔒 Locked — tap to open',
        'lobby.roomLocked': "This room is locked — the host isn't letting new players in.",
        'lobby.kick': 'Remove',
        'lobby.kickTitle': 'Remove {name}?',
        'lobby.kickBody': "They'll be removed from the room. They can rejoin if the room is unlocked.",
        'lobby.kickConfirm': 'Remove',
        'lobby.kickedOut': 'The host removed you from the room.',
        'lobby.away': '💤 Away',
        ...
        'splash.hotSeatContext_link': 'Your friends will take turns naming things. Work out what connects them all, then shout your guess!',
        'splash.helperContext_link': 'Help {name}. Take turns naming real things that fit the secret theme — but keep them guessing!',
        ...
        'play.hotSeatSub_link': 'Your friends will name things. Guess what connects them all — say it out loud.',
        'play.giveCluesFor': 'Give clues for',
        'play.describeIt': 'Describe it to {name} — but never say the word!',
        'play.makeThemGuess': 'Make them guess this theme',
        'play.sayThingsThatFit': 'Take turns naming things that fit — for {name}. Give it away and you\'re next!',
        ...
        'result.linkWasWin': 'The theme was "{word}". +1 win!',
        'result.linkWasLose': 'The theme was "{word}". No win this round.',
        ...
        'info.hotSeatBody_link': `<div class="info-blocks"><p class="info-intro">Your friends can see a secret theme on their phones — like "things that are sticky". You can't. They'll take turns naming things that fit, and your job is to <strong>guess the theme</strong>.</p><div class="info-block"><div class="info-block-emoji">🎧</div><div class="info-block-content"><div class="info-block-title">Listen, then guess out loud</div><div class="info-block-text">They'll name things one by one — honey, glue, tape… When you spot what connects them, say it <strong>out loud</strong>. Guess as often as you like.</div></div></div><div class="info-block"><div class="info-block-emoji">⏳</div><div class="info-block-content"><div class="info-block-title">No timer — take your time</div><div class="info-block-text">There's no clock. We track how long you took and show it after — just a fun stat.</div></div></div><div class="info-block"><div class="info-block-emoji">🎉</div><div class="info-block-content"><div class="info-block-title">When you say the right theme</div><div class="info-block-text">A friend taps <strong>"Hot seat got it!"</strong> the moment you say it. You score <strong>+1 win</strong>.</div></div></div><div class="info-block"><div class="info-block-emoji">🏳️</div><div class="info-block-content"><div class="info-block-title">If you're truly stuck</div><div class="info-block-text">Tap <strong>"I give up"</strong> to end the round. No win, but the game keeps going.</div></div></div></div>`,
        'info.helperBody_link': `<div class="info-blocks"><p class="info-intro">You can see a secret theme on your phone — the hot seat can't. Your job is to <strong>name things that fit</strong> so they can work out the theme.</p><div class="info-block"><div class="info-block-emoji">🧩</div><div class="info-block-content"><div class="info-block-title">Name real things that fit</div><div class="info-block-text">Take turns saying things that truly fit. For "things that are sticky": honey, glue, tape. <strong>They must be real fits</strong> — no making things up.</div></div></div><div class="info-block"><div class="info-block-emoji">😏</div><div class="info-block-content"><div class="info-block-title">Be a little sneaky</div><div class="info-block-text">You're not making it easy! Pick fits that are true but not obvious, so the hot seat has to think. Don't just blurt the theme.</div></div></div><div class="info-block"><div class="info-block-emoji">⏳</div><div class="info-block-content"><div class="info-block-title">No time pressure</div><div class="info-block-text">There's no clock. Go round at your own pace.</div></div></div><div class="info-block"><div class="info-block-emoji">🎉</div><div class="info-block-content"><div class="info-block-title">When they guess the theme</div><div class="info-block-text">Tap <strong>"Hot seat got it!"</strong> the moment they say it. First helper to tap wins it for them.</div></div></div></div>`,
      },
      tr: {
        // Common buttons / actions
        'common.save': 'Kaydet',
        ...
        'games.liarMeta': '2–20 oyuncu · Blöf yap & hayatta kal',
        'games.mafia': 'Mafya',
        ...
        'games.mafiaMeta': '5–20 arkadaş · 1 kişi anlatır',
        ...
        'games.mafiaCardsMeta': '5–20 arkadaş · 1 kişi anlatır',
        ...
        'mafiaCards.role.winTitle': 'Nasıl kazanılır',
        ...
        'mafiaCards.script.detectiveHint': 'Kim kim listesine göz at, sonra Dedektife gizlice Mafyaysa 👍, değilse 👎 göster.',
        'mafiaCards.script.mafiaWakeNote': 'Tüm {n} Mafyanın gözlerini açıp tek bir hedefte anlaşmasını bekle.',
        'mafiaCards.script.mafiaWakeNoteSolo': 'Mafyanın gözlerini açıp bir hedef seçmesini bekle.',
        'mafiaCards.script.dayRevealHint': 'Dün gece kimin öldüğünü duyur — ya da kimsenin ölmediğini. Elenen oyuncu tartışmaya katılmaz.',
        'mafiaCards.script.voteCardsLine': 'Oylama zamanı. Elemek istediğin oyuncuya oy ver.',
        'mafiaCards.script.voteCardsLineDay1': 'İlk gün olduğu için oyuncular oy verebilir ya da atlayabilir. Herkes atlamayı kabul ederse kimse elenmez.',
        'mafiaCards.script.voteNote': 'En çok oyu alan oyuncu elenir. Berabere kalırsa ya da herkes atlamak isterse kimse elenmez. Oyuncu elendikten sonra grupça rolünü açıklamak mı yoksa gizli tutmak mı istediğinize karar verin.',
        'mafiaCards.script.dayDiscussNote': 'Tarafsız kalarak oyuncuların serbestçe tartışmasına izin ver. Herkes hazır olduğunda oylamaya geç.',
        ...
        'mafiaCards.rules.r2.body': '"Dedektif, uyan" dediğinde, Dedektif gözlerini açar ve sessizce bir oyuncuyu işaret eder. O oyuncunun rolünü Kim kim\'den kontrol et, sonra Dedektife <strong>Mafyaysa baş parmak yukarı</strong>, <strong>değilse aşağı</strong> göster. Sadece Dedektif görsün diye elini alçakta tut.',
        'mafiaCards.rules.r2.exception': 'Oyunda Mafya Lideri varsa ve Dedektif onu işaret ederse, yalan söyle — baş parmak aşağı (masum) göster. Mafya Lideri Dedektiften gizlidir. Bu onun özel gücüdür.',
        ...
        'mafiaCards.rules.win.title': 'Kazanma koşulları',
        'mafiaCards.rules.win.body': 'Her turdan sonra, bir sonraki gece başlamadan önce kontrol et. Tüm Mafyalar oylanarak elendiğinde Kasaba kazanır. Mafya, sayıları diğer oyunculara eşit ya da fazla olduğunda kazanır. Henüz kazanan yoksa oyun bir sonraki geceye devam eder.',
        // Anlatıcı ekranı (metin öncelikli yeniden tasarım)
        'mafiaCards.stage.openingTitle': 'Tanışma gecesi',
        'mafiaCards.stage.nightTitle': 'Gece {n}',
        'mafiaCards.stage.dayTitle': 'Gündüz {n}',
        'mafiaCards.stage.readAloud': 'Sesli oku',
        'mafiaCards.stage.nextFirstNight': 'Sıradaki — ilk geceyi başlat',
        'mafiaCards.stage.nextWakeTown': 'Sıradaki — kasabayı uyandır',
        'mafiaCards.stage.nextStartNight': 'Sıradaki — geceyi başlat',
        'mafiaCards.who.btn': 'Kim kim',
        'mafiaCards.who.title': 'Kim kim',
        'mafiaCards.rules.whoSub': 'Gizli kopya kâğıdın — oyuncular bunu görmez. Dedektif birini işaret edince buraya göz at.',
        'mafiaCards.rules.openBtn': 'Kurallar',
        'mafiaCards.rules.sheetTitle': 'Kurallar',
        'mafiaCards.rules.intro': 'Okumak için bir kurala dokun.',
        ...
        'mafia.prototypeHint': '<strong>Herkes kendi telefonunda.</strong> Bir kişi anlatıcı olur — oyunu ekrandaki yönergelerle yönetir ama oynamaz. 5–20 oyuncu + 1 anlatıcı gerekir.',
        ...
        'mafia.rolemixWaiting': 'Dengeli oyun için 5–20 oyuncu gerekir.',
        ...
        'mafia.hintTooMany': 'Çok fazla oyuncu. Maks 20.',
        ...
        'mafia.script.opening.night1MafiaMeet.solo': 'Mafya, gözlerini aç da seni göreyim — bu gece tek başınasın.',
        'mafia.script.opening.night1MafiaMeet.soloDir': 'Bir an bekle — sadece Mafyanın kim olduğunu doğrula, sonra gözlerini kapatsın.',
        ...
        'mafia.script.middle.dayDiscuss.text': 'Şimdi tartışma zamanı. Sizce Mafya kim, neden?',
        ...
        // How-to video scene captions (synced to assets/howto/mafia-tr.mp3).
        'mafia.howto.s1.eyebrow': 'Kurulum',
        'mafia.howto.s1.line': 'Beş arkadaş + bir anlatıcı',
        'mafia.howto.s2.eyebrow': 'Gizli roller',
        'mafia.howto.s2.line': 'Uygulama her oyuncuya gizli bir rol verir',
        'mafia.howto.s3.eyebrow': 'Gece',
        'mafia.howto.s3.line': 'Gözler kapanır. Her rol gizlice hareket eder.',
        'mafia.howto.s4.eyebrow': 'Sabah',
        'mafia.howto.s4.line': 'Kasaba tartışır. Yalanı yakala.',
        'mafia.howto.s5.eyebrow': 'Oylama',
        'mafia.howto.s5.line': 'En çok oy alan elenir',
        'mafia.howto.s6.eyebrow': 'Kazanma',
        'mafia.howto.s6.line': 'Karşı tarafı sayıca geç',
        'mafia.howto.end.title': 'Hazırsın.',
        'mafia.howto.end.sub': 'Arkadaşlarını topla ve oyunu başlat.',
        'mafia.howto.end.replay': 'Tekrar izle',
        'mafia.howto.end.start': 'Oynamaya başla',
        ...
        // "Oyuna katıl" karosu (Oyunlar sekmesi) — iki yol: kod gir ya da QR tara.
        'joinGame.title': 'Oyuna katıl',
        'joinGame.sub': 'Arkadaşından kod ya da QR mı aldın?',
        'joinGame.enterCode': 'Kod gir',
        'joinGame.scanQr': 'QR tara',
        'qrScan.title': 'Arkadaşının QR\'ını tara',
        'qrScan.instruction': 'Kameranı ekrandaki QR koduna doğrult.',
        'qrScan.starting': 'Kamera başlatılıyor…',
        'qrScan.notHuddle': 'Bu bir Huddle oyun QR\'ı değil.',
        'qrScan.permissionDenied': 'Kamera kapalı. Kamera erişimine izin ver ya da kodu gir.',
        'qrScan.noCamera': 'Kamera bulunamadı. Bunun yerine kodu gir.',
        'qrScan.enterInstead': 'Bunun yerine kod gir',
        'joinCode.placeholder': 'ABCD-EFGH',
        'joinCode.btn': 'Katıl',
        ...
        'friends.search': 'İsim veya kullanıcı adıyla arkadaş ekle',
        'friends.searchPlaceholder': 'İsim veya kullanıcı adıyla arkadaş ekle',
        ...
        'friends.emptyList': 'Arkadaş listen boş. Yukarıdan isim veya kullanıcı adıyla arkadaş ekleyebilirsin.',
        'friends.emptyRequests': 'Şu anda arkadaşlık isteği yok.',
        'friends.heroTitle': 'Arkadaşlarını bul',
        'friends.heroSub': 'Yukarıdaki arama kutusuna arkadaşının adını veya kullanıcı adını yaz ve istek gönder.',
        ...
        'lobby.howToSub_link': 'Temayı Bul kuralları',
        // Temayı Bul — adım adım nasıl oynanır (8 adım)
        'tg.howto.s1.eyebrow': 'HAZIRLIK',
        'tg.howto.s1.title': 'Temayı Bul\'a hoş geldin',
        'tg.howto.s1.body': 'Hepiniz aynı odadasınız, herkes kendi telefonunda. Bir oyuncu sıcak koltuğa geçer 🔥 — geri kalan herkes yardımcı.',
        'tg.howto.s2.eyebrow': 'GİZLİ TEMA',
        'tg.howto.s2.title': 'Yardımcılar gizli bir tema görür',
        'tg.howto.s2.body': 'Her elde bir tema var — mesela "Yapışkan şeyler". Yardımcılar telefonlarında görür. Sıcak koltuktaki hiçbir şey görmez.',
        'tg.howto.s3.eyebrow': 'NE SÖYLEYECEKSİN',
        'tg.howto.s3.title': 'Temaya uyan gerçek şeyler say',
        'tg.howto.s3.body': 'Yardımcılar sırayla temaya uyan şeyler söyler. Kurnaz ol — bal aynı zamanda tatlı ve sarı, hemen belli etme!',
        'tg.howto.s4.eyebrow': 'KAÇIŞ',
        'tg.howto.s4.title': 'Temayı yüksek sesle söyle',
        'tg.howto.s4.body': 'Sıcak koltuktaki dinler, çözdüğü an temayı haykırır. Ne kadar hızlı kaçarsan sıralamada o kadar üstte olursun.',
        'tg.howto.s5.eyebrow': 'YAKALANDIN',
        'tg.howto.s5.title': 'Kim ele verdi, göster',
        'tg.howto.s5.body': 'Kaçtın mı? Kimin ipucu ele verdiyse onu seç. Her seçim sayılır — en çok ele veren, final sıralamasında ilan edilir 😅',
        'tg.howto.s6.eyebrow': 'SIRADAKİ KİM',
        'tg.howto.s6.title': 'Koltuk üç şekilde el değiştirir',
        'tg.howto.s6.body': 'Ev sahibi oyun ayarlarından ⚙️ birini seçer — "Ele veren geçer" oyunun klasik hali.',
        'tg.howto.s7.eyebrow': 'TEMA PAKETLERİ',
        'tg.howto.s7.title': 'Tema destenizi seçin',
        'tg.howto.s7.body': 'Ev sahibi ayarlardan ⚙️ bir tema paketi de seçer. Hiçbir tema tekrar etmez — deste bitince oyun final sıralamasıyla biter 👑',
        'tg.howto.s8.eyebrow': 'HAZIRSIN',
        'tg.howto.s8.title': 'Bu kadar — hazırsın!',
        'tg.howto.s8.body': 'Arkadaşlarını topla, kurnaz ol ve sakın ele verme.',
        'tg.howto.hotSeatTag': 'Sıcak koltuk',
        'tg.howto.themeExample': 'Yapışkan şeyler',
        'tg.howto.helperPhone': 'Yardımcılar görür',
        'tg.howto.hotPhone': 'Sıcak koltuk görür',
        'tg.howto.clue1': 'Bal',
        'tg.howto.clue2': 'Yapıştırıcı',
        'tg.howto.clue3': 'Bant',
        'tg.howto.dontSay': '🤫 Temanın kendisini asla söyleme!',
        'tg.howto.shout': '"Yapışkan şeyler!"',
        'tg.howto.escaped': '⏱ 8 saniyede kaçtı',
        'tg.howto.gaveItAway': 'Ele verdi!',
        'tg.howto.way.giver': 'Ele verirsen koltuk senin.',
        'tg.howto.way.rotating': 'Koltuk, oturma sırasına göre dolaşır.',
        'tg.howto.way.random': 'Sıradaki herkes olabilir.',
        'tg.howto.default': 'Varsayılan',
        'tg.howto.letsPlay': 'Hadi oynayalım 🎉',
        'tg.howto.replay': 'Baştan izle',
        'tg.howto.credit': 'Hot Seat parti oyunundan ilhamla.',
        ...
        'howTo.link.slide2Title': 'Biri temayı tahmin eder',
        'howTo.link.slide2Sub': 'Yardımcılar gizli bir temayı görür — mesela "yapışkan şeyler". Sıcak koltuktaki göremez.',
        'howTo.link.slide3Title': 'Yardımcılar uyan şeyler söyler',
        'howTo.link.slide3SubHtml': 'Sırayla gerçekten uyan şeyler söyleyin — bal, yapıştırıcı, bant. Biraz kurnaz olun: <strong>fazla bariz yapmayın</strong>.',
        'howTo.link.slide4Title': 'Ele mi verdin? Sıra sende!',
        'howTo.link.slide4SubHtml': 'Hızlı bilip kurtul. Dikkat edin yardımcılar — <strong>kim ele verirse sıradaki sıcak koltuk onun.</strong>',
        'lobby.settings': 'Ayarlar',
        // Mode-settings sheet (gear button next to Start game)
        'lobby.gameSettings': 'Oyun ayarları',
        'modeset.hostOnly': 'Bu ayarları yalnızca ev sahibi değiştirebilir.',
        // Guess the Theme — theme pack picker (packs defined in LINK_PACKS, app-01)
        'lobby.themePack': 'Tema paketi',
        'themePack.sub': 'Bu oyunda hangi temalar gelebilsin, seç.',
        'themePack.count': '{n} tema',
        'pack.mixed': 'Karışık — hepsi',
        'pack.classic': 'Klasik karışım',
        'pack.everyday': 'Günlük hayat',
        'pack.places': 'Mekânlar & anlar',
        'pack.funny': 'Komik & kurnaz',
        'pack.food': 'Yiyecek & içecek',
        ...
        'mode.link': 'Temayı Bul',
        'mode.sub_link': 'Arkadaşlar şeyler sayar — sen temayı bulursun.',
        'mode.hint_link': '<b>Temayı Bul —</b> Yardımcılar gizli bir temaya uyan şeyler söyler; sıcak koltuktaki neyin bağladığını tahmin eder. Ele veren sıradaki sıcak koltuğa geçer!',
        // In-play mode pill
        'play.modePill.silent': 'Konuşma yok — canlandır',
        'play.modePill.link': 'Temayı Bul',
        'lobby.rounds': 'Tur',
        ...
        'lobby.lockRoom': '🔓 Odayı kilitle',
        'lobby.unlockRoom': '🔒 Kilitli — açmak için dokun',
        'lobby.roomLocked': 'Bu oda kilitli — ev sahibi yeni oyuncu almıyor.',
        'lobby.kick': 'Çıkar',
        'lobby.kickTitle': '{name} çıkarılsın mı?',
        'lobby.kickBody': 'Odadan çıkarılacak. Oda kilidi açıksa tekrar katılabilir.',
        'lobby.kickConfirm': 'Çıkar',
        'lobby.kickedOut': 'Ev sahibi seni odadan çıkardı.',
        'lobby.away': '💤 Uzakta',
        ...
        'splash.hotSeatContext_link': 'Arkadaşların sırayla şeyler sayacak. Hepsini neyin bağladığını çöz, sonra tahminini yüksek sesle söyle!',
        'splash.helperContext_link': '{name} için yardım et. Sırayla gizli temaya uyan gerçek şeyler söyle — ama tahmin ettirme, kurnaz ol!',
        ...
        'play.hotSeatSub_link': 'Arkadaşların şeyler sayacak. Hepsini birbirine bağlayan temayı bul — yüksek sesle söyle.',
        'play.giveCluesFor': 'Tarif et:',
        'play.describeIt': '{name} için tarif et — ama sakın kelimeyi söyleme!',
        'play.makeThemGuess': 'Bu temayı buldur',
        'play.sayThingsThatFit': 'Sırayla buna uyan şeyler söyleyin — {name} için. Ele veren sıradaki olur!',
        ...
        'result.linkWasWin': 'Tema: {word}. +1 galibiyet!',
        'result.linkWasLose': 'Tema: {word}. Bu turda galibiyet yok.',
        ...
        'info.hotSeatBody_link': `<div class="info-blocks"><p class="info-intro">Arkadaşların telefonlarında gizli bir tema görür — mesela "yapışkan şeyler". Sen göremezsin. Sırayla buna uyan şeyler söylerler; senin işin <strong>temayı tahmin etmek</strong>.</p><div class="info-block"><div class="info-block-emoji">🎧</div><div class="info-block-content"><div class="info-block-title">Dinle, sonra yüksek sesle söyle</div><div class="info-block-text">Tek tek şeyler sayarlar — bal, yapıştırıcı, bant… Onları neyin bağladığını çözünce <strong>yüksek sesle</strong> söyle. İstediğin kadar tahmin edebilirsin.</div></div></div><div class="info-block"><div class="info-block-emoji">⏳</div><div class="info-block-content"><div class="info-block-title">Süre yok — acele etme</div><div class="info-block-text">Saat yok. Ne kadar sürdüğünü ölçüp sonunda gösteririz — sadece eğlenceli bir bilgi.</div></div></div><div class="info-block"><div class="info-block-emoji">🎉</div><div class="info-block-content"><div class="info-block-title">Doğru temayı söyleyince</div><div class="info-block-text">Sen söyler söylemez bir arkadaşın <strong>"Sıcak koltuk bildi!"</strong> butonuna basar. <strong>+1 galibiyet</strong> alırsın.</div></div></div><div class="info-block"><div class="info-block-emoji">🏳️</div><div class="info-block-content"><div class="info-block-title">Gerçekten takıldıysan</div><div class="info-block-text"><strong>"Pas geç"</strong> butonuna bas ve turu bitir. Galibiyet yok ama oyun devam eder.</div></div></div></div>`,
        'info.helperBody_link': `<div class="info-blocks"><p class="info-intro">Telefonunda gizli bir tema görürsün — sıcak koltuktaki göremez. Senin işin, onların temayı çözebilmesi için <strong>buna uyan şeyler söylemek</strong>.</p><div class="info-block"><div class="info-block-emoji">🧩</div><div class="info-block-content"><div class="info-block-title">Gerçekten uyan şeyler söyle</div><div class="info-block-text">Sırayla gerçekten uyan şeyler söyleyin. "Yapışkan şeyler" için: bal, yapıştırıcı, bant. <strong>Gerçekten uymalı</strong> — uydurma yok.</div></div></div><div class="info-block"><div class="info-block-emoji">😏</div><div class="info-block-content"><div class="info-block-title">Biraz kurnaz ol</div><div class="info-block-text">İşi kolaylaştırma! Doğru ama bariz olmayan örnekler seç ki sıcak koltuktaki düşünmek zorunda kalsın. Temayı doğrudan söyleme.</div></div></div><div class="info-block"><div class="info-block-emoji">⏳</div><div class="info-block-content"><div class="info-block-title">Süre baskısı yok</div><div class="info-block-text">Saat yok. Kendi hızında sırayla devam et.</div></div></div><div class="info-block"><div class="info-block-emoji">🎉</div><div class="info-block-content"><div class="info-block-title">Temayı bildiklerinde</div><div class="info-block-text">Söyler söylemez <strong>"Sıcak koltuk bildi!"</strong> butonuna bas. İlk basan yardımcı galibiyeti onlar için alır.</div></div></div></div>`,
      },
    };
