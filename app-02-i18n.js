...
// All fragments share ONE global scope and MUST load in numeric order — do not reorder.
    ...
    const STRINGS = {
      en: {
        ...
        'howTo.link.slide4Title': 'Guess it fast to win',
        'howTo.link.slide4SubHtml': 'Each player takes the hot seat. The <strong>fastest to guess the theme</strong> takes the crown.',
        ...
        'mode.hint_link': '<b>Guess the Theme —</b> Helpers see a secret theme and take turns naming things that fit. The hot seat works out what connects them all.',
        ...
        'play.sayThingsThatFit': 'Take turns naming things that fit — for {name}. Don\'t make it too easy!',
      ...
      tr: {
        ...
        'howTo.link.slide4Title': 'Hızlı bul, kazan',
        'howTo.link.slide4SubHtml': 'Her oyuncu sırayla sıcak koltuğa geçer. Temayı <strong>en hızlı bulan</strong> tacı alır.',
        ...
        'mode.hint_link': '<b>Temayı Bul —</b> Yardımcılar gizli bir temayı görür ve sırayla ona uyan şeyler söyler. Sıcak koltuktaki kişi hepsini birbirine bağlayan temayı çözer.',
        // In-play mode pill
        ...
        'play.sayThingsThatFit': 'Sırayla buna uyan şeyler söyleyin — {name} için. Fazla kolaylaştırma!',
