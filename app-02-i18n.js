...
// All fragments share ONE global scope and MUST load in numeric order — do not reorder.
    ...
    const STRINGS = {
      en: {
        ...
        'th.howto.s1.eyebrow': 'SAME ROOM',
        'th.howto.s1.line': 'You\'re all together — each on your own phone.',
        'th.howto.s2.eyebrow': 'THE SECRET',
        'th.howto.s2.line': 'Everyone sees a secret theme — except the hot seat.',
        'th.howto.s3.eyebrow': 'DROP CLUES',
        'th.howto.s3.line': 'Take turns naming real things that fit.',
        'th.howto.s4.eyebrow': 'CRACK IT',
        'th.howto.s4.line': 'The hot seat works out the theme — and shouts it!',
        'th.howto.s5.eyebrow': 'STAY SNEAKY',
        'th.howto.s5.line': 'Give it away and you\'re next in the hot seat!',
        'th.howto.themeExample': 'Things that are sticky',
        'th.howto.helpersSee': 'Helpers see this',
        'th.howto.hotSeatHidden': 'Hot seat: hidden',
        'th.howto.clue1': 'Honey',
        'th.howto.clue2': 'Glue',
        'th.howto.clue3': 'Tape',
        'th.howto.clue4': 'Gum',
        'th.howto.end.title': 'You\'re ready!',
        'th.howto.end.sub': 'Round up your friends and guess the theme.',
        'th.howto.end.replay': 'Watch again',
        'th.howto.end.start': 'Let\'s play',
        'th.howto.end.credit': 'Inspired by the Hot Seat party game.',
      ...
      tr: {
        ...
        'th.howto.s1.eyebrow': 'AYNI ODA',
        'th.howto.s1.line': 'Hepiniz bir aradasınız — herkes kendi telefonunda.',
        'th.howto.s2.eyebrow': 'GİZLİ TEMA',
        'th.howto.s2.line': 'Sıcak koltuktaki hariç herkes gizli temayı görür.',
        'th.howto.s3.eyebrow': 'İPUCU VER',
        'th.howto.s3.line': 'Sırayla temaya uyan gerçek şeyler söyleyin.',
        'th.howto.s4.eyebrow': 'ÇÖZ',
        'th.howto.s4.line': 'Sıcak koltuktaki temayı çözer — ve yüksek sesle söyler!',
        'th.howto.s5.eyebrow': 'KURNAZ OL',
        'th.howto.s5.line': 'Ele verirsen sıradaki sıcak koltuk sensin!',
        'th.howto.themeExample': 'Yapışkan şeyler',
        'th.howto.helpersSee': 'Yardımcılar bunu görür',
        'th.howto.hotSeatHidden': 'Sıcak koltuk: gizli',
        'th.howto.clue1': 'Bal',
        'th.howto.clue2': 'Yapıştırıcı',
        'th.howto.clue3': 'Bant',
        'th.howto.clue4': 'Sakız',
        'th.howto.end.title': 'Hazırsın!',
        'th.howto.end.sub': 'Arkadaşlarını topla ve temayı bul.',
        'th.howto.end.replay': 'Tekrar izle',
        'th.howto.end.start': 'Hadi oynayalım',
        'th.howto.end.credit': 'Hot Seat parti oyunundan ilhamla.',
